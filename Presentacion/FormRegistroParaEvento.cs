...
{
    public partial class FormRegistroParaEvento : Form
    {
        private int cont;
        ...
        public FormRegistroParaEvento(int codigo_administrador)
        {
            InitializeComponent();
        ...
        private void btnRegistrar_Click(object sender, EventArgs e)
        {
            if (tbDireccion.Text == "" || cbDistritos.Text == "" || tbCantidad.Text == "" ||
                dateTimePicker2.Text == "" || cbSabor.Text == "" || cbTamaño.Text == "" || cbTematica.Text == "")
            {
            ...
            {
                codigo = cantidad,
                fecha_entrega = dateTimePicker2.Value,
